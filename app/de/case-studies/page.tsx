...
export const metadata: Metadata = {
  title: 'Telcotank — Erfolgsgeschichten',
  description: 'Telcotank präsentiert erfolgreiche Transformationsfälle und Beratungsergebnisse.',
  alternates: {
    canonical: 'https://telcotank.com/de/case-studies/',
    languages: {
...
export default function Page() {
  return <CaseStudiesLocalized lang="de" />
}
